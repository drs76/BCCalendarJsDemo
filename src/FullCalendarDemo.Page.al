...
page 50200 PTEFullCalendarDemo
{
    ...
    layout
    {
        area(content)
        {
            usercontrol(FullCalendar; PTEFullCalendarControl)
            {
                ApplicationArea = All;
                ...
                begin
                    ...
                    CurrPage.FullCalendar.GetEventsResult(EventMgt.GetEvents());
                end;
                ...
                begin
                    Clear(ResourceMgt);
                    BuildResources();
                    CurrPage.FullCalendar.GetResourcesResult(ResourceMgt.GetResources());
                end;
                ...
                begin
                    ...
                    CurrPage.FullCalendar.UpdateBCWithCalendarEntryResult(JResult);
                end;
    ...
    begin
        ...
        if Dragged then begin
            ...
            CurrPage.FullCalendar.HandleExternalDraggedEventResult(JsonResult); // return empty for async call.
        end else
            CurrPage.FullCalendar.OpenCalendarEntryResult(JsonResult) //send the changed data back to calendar js
    end;
    ...
    begin
        ...
        if not SalesHeader.Get(SalesHeader."Document Type"::Order, OrderNo) then begin
            CurrPage.FullCalendar.HandleExternalDraggedEventResult(JResult); // return empty for async call.
            exit;
        end;
    ...
    begin
        ...
        CurrPage.FullCalendar.InitCalendar(CalendarSetupMgt.GetCalendarSetup(), true); //setup & show calendar with initial view draggable is enabled.
        CurrPage.FullCalendar.SetInitialDate(Today()); // move to a specific date on start
    end;
